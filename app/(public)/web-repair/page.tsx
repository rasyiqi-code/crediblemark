...
export async function generateMetadata(
    ...
    const defaultTitle = isId 
        ? `Jasa Perbaikan Website & Penyelamat Kode AI | ${brand}`
        : `Professional Web Repair & AI Code Refactoring | ${brand}`;
    const defaultDesc = isId 
        ? "Jasa perbaikan website lambat, penuh bug, dan kode berantakan akibat vibecoding. Refactoring kode AI menjadi modular, cepat, aman, dan berstandar industri."
        : "Professional rescue for slow, buggy websites and messy AI-generated code. Refactoring spaghetti code into fast, secure, and modular architectures.";
            ...
            <section className="relative pt-20 pb-12 md:pt-28 md:pb-16 flex flex-col items-center text-center px-4 sm:px-6">
                ...
                <div className="container mx-auto max-w-4xl space-y-6 animate-hero-fade-in relative z-10">
                    ...
                    <h1 className="text-4xl sm:text-6xl md:text-7xl font-black tracking-tight text-white leading-[1.1]">
                        {isId ? "Penyelamat Kode Website " : "Professional Web "}
                    ...
                    <p className="text-zinc-400 text-sm sm:text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                        {isId
                            ? "Website Anda lambat, penuh bug, atau sulit dikembangkan akibat kode AI asal jadi? Kami merapikan, menata arsitektur, dan meningkatkan performa web Anda secara instan."
                            : "Is your site slow, buggy, or unmaintainable due to copy-pasted AI code? We refactor arsitechture, fix logical leaks, and secure your systems with senior precision."}
                    </p>
                            ...
                            <div className="space-y-2.5 sm:space-y-4">
                                <div className="flex items-center gap-3 sm:block">
                                    ...
                                    <h3 className="text-base sm:text-xl font-bold text-white group-hover:text-amber-500 transition-colors sm:mt-4">
                                        {isId ? "Pembersihan Kode AI & Refactoring" : "AI Code Cleanup & Refactoring"}
                                    </h3>
                                </div>
                                <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
                                    {isId
                                        ? "Kami menyusun ulang satu file monolitik ribuan baris buatan AI menjadi modul-modul kecil yang rapi dan DRY (Don't Repeat Yourself). Struktur yang bersih membuat aplikasi Anda jauh lebih mudah dipelihara dan dikembangkan oleh tim developer Anda."
                                        : "We split huge, messy single-file codebases generated by AI into modular, clean, and DRY components. A structured system keeps your application highly maintainable for future expansions."}
                                </p>
                            </div>
                        </div>
